...
@section('title','Chi tiết sim viettel')
@section('content')
<div class="wrapper mt-4">
    <div class="clearfix">
        <span class="text-uppercase" style="font-size: 15px;font-weight: 700;margin-left: 15px;">Sim Viettel</span>
    ...
    <div class="container mt-2">
        <div class="row">
            <div class="form-group col-md-4">
                <select id="timKiemTheoDauSo" class="form-control inputState">
                    ...
                    <option value="08">Đầu 086</option>
                </select>
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="contenttext mt-2">
            ...
            <p>Hiện nay thì hình thức hỗ trợ khách hàng mua sim trả góp tại Sim VNN với mức giá áp dụng trả góp là từ 10
            ...
            <p>Hầu hết các loại sim số thần tài, lộc phát, tam hoa tứ quý, lục quý… có giá 10 triệu trở lên của các nhà
                mạng đều được Sim VNN hỗ trợ trả góp với lợi ích hướng đến khách hàng.</p>
            <p><strong><img src="../img/raw.gif" alt="">Xem ngay: </strong><a href="">Danh sách sim trả góp đẹp tại Sim
                    VNN</a></p>
            <p><b>4. Dịch vụ trả góp tại Sim VNN như thế nào?</b></p>
            ...
            <strong>Đến với Sim VNN bạn sẽ được:</strong>
            <ul>
            ...
            <p><em>Nhanh tay Mua Sim Trả Góp ngay hôm nay tại Sim VNN để thỏa đam mê sở hữu Sim Số Đẹp trong tay
                    nào..!</em></p>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		var table = $('#datatable').DataTable({
			...
			ajax: {
				url: "{{ route('font-end.detail_table_viettel') }}",
				data: function (d) {
